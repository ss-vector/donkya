	...
	<div id="primary" class="site-main">
		<main id="page" class="container">
			<div class="section-wrapper row main">
				<div class="col-xl-12">
					<div class="mt-5">
						<h2 class="display-4 fw-bold text-center">About Us</h2>
						<div class="container-fluid py-5">
							...
							<p class="col-md-8 fs-4"><strong>DONKYA</strong> was born out of an interest in restoring and preserving our natural environments.</p>
							<p class="col-md-8 fs-6">With recycled material we could do lots of stuff, we need to share the value left in the trash.</p>
						</div>
					</div>
				</div>
			</div>
			<div class="section-wrapper">
				<div class="container-fluid py-5">
					<p class="col-md-8 fs-4">We know that our story so far went from being nomads to having the power to shape our enviroment, and nowadays problem of pollution is putting us in a hurry.</p>
				</div>
			</div>
			<div class="section-wrapper">
			...
			<div class="section-wrapper row">
				<div class="col-xl-12">
					<div class="container-fluid mt-5">
						...
						<p class="fs-6">The first plastic was produced in the early 1900s. Now, more than 100 years later, it has become one of the biggest global problems.</p>
